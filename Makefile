...
OPTIONS = -DUSB_PANEL -DF_CPU=$(TEENSY_CORE_SPEED) -DLAYOUT_US_ENGLISH
...
CPPFLAGS = -Wall -g -Os -mthumb -ffunction-sections -fdata-sections -nostdlib -MMD $(OPTIONS) -DTEENSYDUINO=124 -Isrc -I$(COREPATH)
